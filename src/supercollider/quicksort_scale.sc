...
OSCdef(\scale_boot_OSC_QUICKSORT, {
	arg msg;
	"\\scale_boot_OSC_QUICKSORT - arguments: [".post;msg[1].post;"]".postln;
	if(msg[1]=='status',
		{
			~address.sendMsg("/scale_boot_QUICKSORT");
		},
		{
			// Play boot sound
...
OSCdef(\scale_start_OSC_QUICKSORT, {
	arg msg;
	"\\scale_start_OSC_QUICKSORT - arguments: [".post;msg[1].post;"]".postln;
	if(msg[1]=='status',
		{
			~address.sendMsg("/scale_start_QUICKSORT");
		},
		{
			~initscale;
		}
...
OSCdef(\scale_set_maxfreq_OSC_QUICKSORT, {
	...
	if(msg[1]=='status',
		{
			~address.sendMsg("/scale_set_maxfreq_QUICKSORT");
		},
		{
...
OSCdef(\scale_set_minfreq_OSC_QUICKSORT, {
	...
	if(msg[1]=='status',
		{
			~address.sendMsg("/scale_set_minfreq_QUICKSORT");
		},
		{
...
OSCdef(\scale_set_amp_OSC_QUICKSORT, {
	arg msg;
	"\\scale_set_amp_OSC_QUICKSORT - arguments: [".post;msg[1].post;"]".postln;
	if(msg[1]=='status',
		{
			~address.sendMsg("/scale_set_amp_QUICKSORT");
		},
		{
			~amp = msg[1];
		}
...
OSCdef(\scale_set_OSC_QUICKSORT, {
	arg msg;
	var midi;
	"\\scale_set_OSC_QUICKSORT - arguments: [".post;msg[1].post;"]".postln;
	if(msg[1]=='status',
		{
			~address.sendMsg("/scale_set_QUICKSORT");
		},
		{
			...
			"\\scale_set_OSC_QUICKSORT - arguments: [\midi: ".post;midi.post;", \pan: ".post;msg[2].post;", amp: ".post;~amp.post;"]".postln;
...
OSCdef(\scale_status_OSC_QUICKSORT, {
	arg msg;
	"\\scale_status_OSC_QUICKSORT - arguments: [".post;msg[1].post;"]".postln;
	if(msg[1]=='status',
		{
			~address.sendMsg("/scale_hello_QUICKSORT");
		},
		{
			if(x==0,
